    ...
    <div className={styles.searchOuterContainer}>
      ...
      >
        ...
        <div className={styles.row} style={{ marginTop: "8px" }}>
          ...
          />
          <label htmlFor="showLocalResultsOnly">Show Only Results Within</label>
        </div>
        <div className={styles.row}>
          ...
          <label style={{ width: "104px", marginRight: "4px" }}>miles of</label>
        </div>
        {userLocation && (
          <div className={styles.row} style={{ marginTop: "8px" }}>
            <input
            ...
            />
            <label htmlFor="this-device">Use this Device's Location</label>
          </div>
        )}
        ...
        <div className={styles.row} style={{ marginTop: "8px" }}>
          ...
          />
          <label htmlFor="enter-city">Enter a City:</label>
        </div>
