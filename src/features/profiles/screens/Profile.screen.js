...
export const Profile = () => {
  const { user, onUpdate, isLoading } = useContext(AuthenticationContext);
    ...
    <div className={styles.profileContainer}>
      ...
      >
        ...
        >
          <button
            className="btn"
            style={{ position: "absolute", bottom: "-23px", right: "52.5px" }}
            onClick={(event) => {
        ...
        <div className={styles.contentInnerContainer}>
          ...
          <div className={styles.contentBtnRow}>
            <button
              ...
              style={{ visibility: aboutEditEnabled ? "visible" : "hidden" }}
              onClick={(event) => {
