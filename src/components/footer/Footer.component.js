    ...
    <footer className={styles.footer}>
      <div className={styles.upperContainer}>
        ...
        <div className={styles.column}>
          {!isAuthenticated ? (
            <>
              <HashLink to="/register#register-form" className={styles.link}>
                Register
              </HashLink>
              <HashLink to="/login#login-form" className={styles.link}>
                Login
              </HashLink>
            </>
          ) : (
        ...
        <div className={styles.column}>
          <HashLink to="/contact#contact-form" className={styles.link}>
            Contact Us
          </HashLink>
          <HashLink
            to="/termsandconditions#terms-and-conditions-header"
